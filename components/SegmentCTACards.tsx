...
const SEGMENTS = [
  {
    ...
    description: 'Room for the whole clan — six bedrooms and five ensuites, a heated pool, home theatre and games room. Grandparents, parents and kids together, with the beach just a short stroll away.',
  ...
  },
  {
    ...
    description: 'Your Peninsula golf base, minutes from Moonah Links, The Dunes and The National. Sleeps up to 16 with generous shared spaces to relax, regroup and replay the round.',
    icon: 'golf_course',
    reviewFilter: 'golf',
  },
  {
    ...
    description: 'Swap the hotel for a private estate just 90 minutes from Melbourne. Theatre, breakout lounges, dining and beach walks make for a focused, recharging team offsite.',
    icon: 'groups',
    reviewFilter: 'all',
  },
  {
    ...
    description: 'Celebrate any big milestone — birthdays, anniversaries and reunions — with up to 16 guests under one roof. Room for everyone to gather, toast and stay the night, no need to leave the party.',
    icon: 'celebration',
